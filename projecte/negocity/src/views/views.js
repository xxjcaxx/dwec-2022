...
class View {
  ...
  render(Item) {
    // Esta funció serà sobreescrita per cada vista
  }
  ...
  mostrarFormulario() {
    // Este és per a mostrar el formulari de creació, crida internament a construirFormulario
  }

  editItem(Item, divItem) {
    // funció base que crea el formular i cancelar. El botó enviar es tindrà que escriurer
    divItem.innerHTML = "";
